...
<main>
	<section class="view">
		...
		<table>
			...
			<tr>
				<td>내용</td>
			<td><textarea  name="content" readonly><%= dto.getContent() %></textarea>
			</td>
		</table>
		<div>
		...
		<section class="commentList">
			...
			<article class="comment">
				...
				<textarea name="comment" readonly><%= comment.getComment() %></textarea>
				<% if(sessUser.getUid().equals(comment.getWriter())) { %>
				<div>
					<a href="/Jboard1/proccommentDelete.jsp?no=<%= comment.getNo() %>" class="del">삭제</a> 
					<a href="#" class="">수정</a>
				</div>
				<% } %>
			</article>
