	...
	<section class="myInfo">
		<form action="#" method="post">
			<table border="1">
				...
				<tr>
					...
					<td><input type="password" name="pass2"
						...
						<button type="button" class="btnUpdatePass">비밀번호 수정</button></td>
				</tr>
				<tr>
					<td>회원가입날짜</td>
			...
			<table border="1">
				...
				<tr>
					<td>이메일</td>
					<td><input type="email" name="email" placeholder="이메일 입력" /> <span
						class="emailResult"></span>
				...
				<tr>
					<td>주소</td>
					<td><input type="text" name="zip" id="zip" readonly="readonly"
						placeholder="우편번호" />
						<button type="button">
			...
			<div>
				<a href="/Jboard2/user/login.do" class="btn btnCancel">취소</a> <input
